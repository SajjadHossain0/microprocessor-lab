...
.data
msg db 'Hello $'  ; Message to display "Hello"
msg1 db 'Enter any character: $'  ; Input prompt message
msg2 db 'The entered character is: $'  ; Output message
...
main proc  
    ...
    lea dx, msg     ; Load the effective address of the message into DX  
    ...
    lea dx, msg1    ; Load the effective address of the input prompt  
    ...
    ; --------------------------------------------  
    mov ah, 9       ; DOS function to display a string  
    lea dx, msg2    ; Load the effective address of the output message  
